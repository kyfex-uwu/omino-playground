...
exportMod({
    ...
    scenes:{
        ...
        settings:{
            ...
            bg:{
                0:colorFuncs.hexToRGB(0x101010),
                1:colorFuncs.hexToRGB(0x191919),
            },
            text:colorFuncs.hexToRGB(0xffffff),
            modal:{
                bg:"default:buttons.dark.bg",
        ...
        createOmino:{
            ...
            modal:()=>{
                ...
                image.src="/ominoes/create_omino.png";
        ...
        changeBoard:{
            darken:"default:util.darken",
            modal:colorFuncs.hexToRGB(0x593669),
            outline:colorFuncs.hexToRGB(0xf2efeb),
            button:colorFuncs.hexToRGB(0xf2efeb),
            buttonHover:colorFuncs.hexToRGB(0xffffff),
            text:colorFuncs.hexToRGB(0x000000),
        }
    },
